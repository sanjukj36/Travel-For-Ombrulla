...
function Services() {
    return (
        <section className='flex service-Body justify-between my-20'>
            <div className='m-20' >
            ...
            <div>
                <div className='flex service-content-container'>
                    <div className='service-content flex flex-col items-center box-border h-56 w-52 p-4 shadow border-gray-50 rounded-t-lg rounded-b-lg m-4 hover:bg-indigo-600 hover:text-zinc-100 duration-500'>
                        <img className='lazyload object-center w-' src={destination} alt=""  loading="lazy"/>
                    ...
                    <div className='service-content flex flex-col items-center box-border h-56 w-52 p-4 shadow border-gray-50 rounded-t-lg rounded-b-lg m-4 hover:bg-indigo-600 hover:text-zinc-100 duration-500'>
                        <img className='lazyload object-center w-' src={booking} alt=""  loading="lazy"/>
                    ...
                    <div className='service-content flex flex-col items-center box-border h-56 w-52 p-4 shadow border-gray-50 rounded-t-lg rounded-b-lg m-4 hover:bg-indigo-600 hover:text-zinc-100 duration-500'>
                        <img className='lazyload object-center w-' src={cloudy} alt="" loading="lazy"/>
