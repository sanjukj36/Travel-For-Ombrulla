        ...
        <>
            ...
            <div className='container mt-6 py-5 '>
                <div class="flex justify-between landing">
                    <div class="flex ord1">
                        <div className='HeaderContent  mt-64'>
                            <div className="bag flex gap-4 px-8 py-4 text-sm font-bold text-pink-500 bg-white shadow-xl rounded-[100px] ml-10">
                                ...
                                <img src={bag} className="shrink-0 w-6 aspect-square" />
                            </div>
                            <div className='hw'>
                            ...
                            <div className="flex absolute lg:flex lg:relative">
                                ...
                                <button className="flex justify-center px-8 py-4 text-gray-800 bg-transparent hover:bg-indigo-600 hover:text-zinc-100 rounded-[100px] max-md:px-5 duration-500"><img className='m-1' src={playCircle} alt="" /> Watch Demo</button>
                            </div>
                        ...
                        <img src={headerRightSide} className="w-full right-0 mx-auto mt-16 ord2" />
