            ...
            <div className='md:flex'>
                <div className='md:w-1/3 p-4'>
                    <div className='shadow-2xl rounded-md'>
                        <img width={"500px"} className='img-card lazyload' src={Rectangle1} alt='no' loading="lazy" />
                        <div className='mt-5'>
                ...
                <div className='md:w-1/3 p-4'>
                    <div className='shadow-2xl rounded-md'>
                        <img width={"500px"} className='img-card lazyload' src={Rectangle2} alt='no' loading="lazy" />
                        <div className='mt-5'>
                            <div className='flex justify-between items-center px-5'>
                                <h3 className='text-xl font-bold'>Paradise Beach,<br />Bantayan Island</h3>
                                <h3 className='text-xl font-bold text-pink-500'>$550.16</h3>
                ...
                <div className='md:w-1/3 p-4'>
                    <div className='shadow-2xl rounded-md'>
                        <img width={"500px"} className='img-card lazyload' src={Rectangle3} alt='no' loading="lazy" />
                        <div className='mt-5'>
                            <div className='flex justify-between items-center px-5'>
                                <h3 className='text-xl font-bold'>Paradise Beach,<br />Bantayan Island</h3>
                                <h3 className='text-xl font-bold text-pink-500'>$550.16</h3>
